...
Insert into category ( cat_id,cat_descr ) Values (132 , 'This category embeds fabric products');
...
Insert into product ( prod_id,name,descr,price,quant,cat_id ) Values (13 ,'rotisserie','This is a tool for your holidays house.',10,50, 124);
...
Insert into product ( prod_id,name,descr,price,quant,cat_id ) Values (16 ,'door','This is a door fot he main entrance of the home',80,10,121);
...
alter table supplier alter column email varchar(30);
...
Insert into has(prod_id,passw) Values ('18','1006');
select * from record;
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(500,1000,14,'20110104',1);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(501,1000,14,'20110805',1);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(502,1005,15,'20110512',3);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(503,1001,12,'20110520',1);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(504,1003,16,'20110825',2);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(505,1005,15,'20110507',3);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(506,1006,20,'20110623',3);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(507,1004,17,'20110814',2);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(508,1007,19,'20110920',2);
Insert into record(rec_id,supplier_id,prod_id,rec_date,quant_rec) Values(509,1008,21,'20110518',1);
...
Insert into payment(cust_id,paym_date,amount) Values(10070,'20120706',300.00);
Insert into payment(cust_id,paym_date,amount) Values(10070,'20120806',150.00);
Insert into payment(cust_id,paym_date,amount) Values(10090,'20120301',300.00);
Insert into payment(cust_id,paym_date,amount) Values(11000,'20110902',500.00);
Insert into payment(cust_id,paym_date,amount) Values(11000,'20121104',800.00);
Insert into payment(cust_id,paym_date,amount) Values(10070,'20110706',150.00);
select* from orders;
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (001,'20110310','20110313',10010);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (002,'20110510','20110513',10040);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (003,'20110612','20110617',10020);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (004,'20111402','20110217',10060);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (005,'20120318','20120320',10070);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (006,'20120310','20120313',10020);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (007,'20110515','20120518',10080);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (008,'20120610','20120613',10090);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (009,'20120327','20120330',10000);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (010,'20110220','20110223',10030);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (011,'20110427','20110429',10050);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (012,'20110705','20110706',10060);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (013,'20110110','20110112',10070);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (014,'20120908','20120911',10000);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (015,'20110516','20110519',10070);
Insert into orders(order_id,order_date,dispatch_order,cust_id) Values (016,'20120601','20120605',10080);



select cust_name,customer.cust_id,order_id from customer,orders where customer.cust_id = orders.cust_id ;
select prod_id,name from product;

Insert into set_of_products(order_id,prod_id,quant_prod) Values (002,006,2.00);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (19,009,3.00);
select * from set_of_products;
delete from set_of_products;
Insert into set_of_products(prod_id,order_id,quant_prod) Values (15,001,5);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (13,006,8);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (13,003,4);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (10,006,7);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (11,003,20);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (10,006,5);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (21,012,19);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (19,014,30);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (18,002,12);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (12,012,25);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (19,015,12);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (16,007,5);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (11,008,9);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (17,014,15);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (14,011,5);
...
Insert into set_of_products(prod_id,order_id,quant_prod) Values (19,005,9);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (19,006,5);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (17,009,13);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (17,014,5);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (11,012,10);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (19,005,4);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (17,014,12);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (16,016,3);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (17,010,8);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (21,008,21);
Insert into set_of_products(prod_id,order_id,quant_prod) Values (17,009,8);